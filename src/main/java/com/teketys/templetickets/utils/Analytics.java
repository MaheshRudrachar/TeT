...
public class Analytics {
    ...
    public static void logOrderCreatedEvent(Cart orderCart, String orderRemoteId, Double orderTotalPrice, Shipping selectedShipping) {
        ...
        Map<String, String> event = new HitBuilders.TransactionBuilder()
                ...
                .setCurrencyCode((orderCart != null)? orderCart.getItems().get(0).getCurrency() : "INR")
                .build();
        sendEventToAppTrackers(event);
        ...
        parametersCheckout.putString(AppEventsConstants.EVENT_PARAM_CURRENCY, (orderCart != null)? orderCart.getItems().get(0).getCurrency() : "INR");
        ...
        parametersShip.putString(AppEventsConstants.EVENT_PARAM_CURRENCY, (orderCart != null)? orderCart.getItems().get(0).getCurrency() : "INR");
        ...
        for (int i = 0; i < orderCart.getItems().size(); i++) {
            ...
            String price = item.getPriceFormatted();
            //TODO: check discount
            ...
            Map<String, String> eventSingle = new HitBuilders.ItemBuilder()
                    ...
                    .setSku("Product id: " + item.getProduct_id())
            ...
            Bundle parameters = new Bundle();
            parameters.putString(AppEventsConstants.EVENT_PARAM_CONTENT_TYPE, PRODUCT);
            parameters.putLong(AppEventsConstants.EVENT_PARAM_CONTENT_ID, item.getProduct_id());
            parameters.putInt(AppEventsConstants.EVENT_PARAM_NUM_ITEMS, item.getQuantity());
            parameters.putString(AppEventsConstants.EVENT_PARAM_CURRENCY, (orderCart != null)? orderCart.getItems().get(0).getCurrency() : "INR");
