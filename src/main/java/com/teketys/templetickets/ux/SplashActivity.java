...
public class SplashActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //SettingsMy.getSettings().edit().clear().commit();

        if ((SettingsMy.getAPIToken() == null || SettingsMy.getAPIToken() == "") && (SettingsMy.getActiveUser() == null)) {
    ...
    private void setSpinShops(List<ShopMetaData> shopMetaDataList) {
        if (shopMetaDataList != null && !shopMetaDataList.isEmpty()) {
            ...
            Timber.e(new RuntimeException(), "Trying to set empty shops metadata array.");
        }
    }

    private void setSpinShopDetails(List<Shop> shopList) {
