...
import com.teketys.templetickets.entities.BannersResponse;
import com.teketys.templetickets.entities.Metadata;
import com.teketys.templetickets.interfaces.BannersRecyclerInterface;
...
public class BannersFragment extends Fragment {
    ...
    private Metadata bannersMetadata = null;
    ...
    private void prepareContentViews(View view, boolean freshStart) {
        ...
        bannersRecycler.setHasFixedSize(false);
