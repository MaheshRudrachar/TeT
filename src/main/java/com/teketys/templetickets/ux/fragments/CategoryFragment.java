...
import com.teketys.templetickets.interfaces.CategoryRecyclerInterface;
import com.teketys.templetickets.interfaces.FilterDialogInterface;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (startBundle != null) {
            ...
            if (productsRecyclerAdapter == null || productsRecyclerAdapter.getItemCount() == 0) {
                ...
                //To set the pagination for the first time
